defmodule ForwardleWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ForwardleWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ForwardleWeb.Gettext, "errors", msg, opts)
    end
  end
